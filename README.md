...
Self-contained, portable notebooks powered by the Observable runtime.

**[Browse the gallery](https://tomlarkworthy.github.io/lopebooks/notebooks/@tomlarkworthy_gallery.html)**

## Not in the gallery

These are linked here so they are reachable; they are not listed in `content.json`.

| Notebook | Description |
|----------|-------------|
| [SVG Lens](https://tomlarkworthy.github.io/lopebooks/notebooks/tomlarkworthy_svg-lens.html) | Editing a drawing by editing its program — a bidirectional SVG editor where the drawing syncs to the code and the code to the drawing, without parsing away animations or template holes |
